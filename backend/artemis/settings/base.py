...
REGISTRATION_REQUIRE_EMAIL_ACTIVATION = config(
...
SPECTACULAR_SETTINGS = {
    "TITLE": "ArtemisApp API",
    "DESCRIPTION": "API para ArtemisApp — control de ganado bovino, RFID, lotes e inventario",
    "VERSION": "0.1.0",
...
STATICFILES_DIRS = (
    base_dir_join("../frontend", "webpack_bundles"),
