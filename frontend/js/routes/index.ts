...
import GuestOnlyRoute from '@/js/components/GuestOnlyRoute';
...
import ActivatePage from '@/js/pages/auth/ActivatePage';
import ResetPasswordConfirmPage from '@/js/pages/auth/ResetPasswordConfirmPage';
import ResetPasswordPage from '@/js/pages/auth/ResetPasswordPage';
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/recuperar-contrasena', Component: ResetPasswordPage },
    ],
  },
  {
